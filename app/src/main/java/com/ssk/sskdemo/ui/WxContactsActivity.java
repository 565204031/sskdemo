...
import com.ssk.sskdemo.utils.CharacterParser;
 ...
 *
 */
public class WxContactsActivity extends BaseToolBarActivity{
	...
	protected int getContentView() {
		return R.layout.ui_activity_wxcontacts;
	}

	@Override
	protected void initView(Bundle savedInstanceState) {
		sidebar=(WxContactsSideBar)findViewById(R.id.sidebar);
		listview= (ListView) findViewById(R.id.listview);
		tv_content= (TextView) findViewById(R.id.tv_content);
		sidebar.setTextView(tv_content);
		sidebar.setListener(new WxContactsSideBar.setWxSideBarListener() {
			@Override
	...
	private class Adapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(convertView==null){
				...
				convertView=LayoutInflater.from(mContext).inflate(R.layout.ui_item_wxcontacts, null);
